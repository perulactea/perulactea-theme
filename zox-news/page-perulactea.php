...
<?php if(get_option('mvp_home_layout') == '0' || get_option('mvp_home_layout') == '2') { ?>
		...
		<div class="mvp-main-blog-wrap left relative">
			<div class="mvp-main-box mvp-main-box-homeperulactea">
				<div class="mvp-main-blog-cont left relative">
					...
					<div class="mvp-main-blog-out mvp-main-blog-out-homeperulactea left relative">
...
<aside id="sidebar" role="complementary" class="sidebar-perulactea fusion-widget-area fusion-content-widget-area fusion-sidebar-left fusion-blogsidebar fusion-sticky-sidebar" style="float: right; float: left;" data-width="21%" data-margin="calc(-100% + ( / 2) + 21%)">
			...
			<div class="fusion-sidebar-inner-content">
				<div class="perulactea-ads ad-overlay left-banner1-ad"><iframe style="width: 200px; height: 385px;" src="https://perulactea.com/banner/Banner_Modivitasan_final_nuevo/index.html"></iframe></div>
				<div class="perulactea-ads left-banner2-ad"><iframe style="width: 200px; height: 250px;" src="https://perulactea.com/banner/banner_selec_sires/index.html"></iframe></div>
...
<aside id="sidebar-2" role="complementary" class="sidebar-perulactea fusion-widget-area fusion-content-widget-area fusion-sidebar-right fusion-blogsidebar fusion-sticky-sidebar" style="float: left;" data-width="21%" data-margin="calc( / 2)">
			...
			<div class="fusion-sidebar-inner-content">
				<div class="perulactea-ads right-banner1-ad"><iframe style="width: 200px; height: 385px;" src="https://perulactea.com/banner/Banner_Tulamycin/index.html"></iframe></div>
				<div class="perulactea-ads right-banner2-ad"><iframe style="width: 200px; height: 250px;" src="https://perulactea.com/banner/Banner_tecnogiras/index.html"></iframe></div>
